...
- *Example*: "Compare AWS vs. Google Cloud vs. Azure approaches to AI infrastructure" → Use 3 sub-agents
- Store findings in separate files: `findings_aws_ai.md`, `findings_google_cloud_ai.md`, `findings_azure_ai.md`
